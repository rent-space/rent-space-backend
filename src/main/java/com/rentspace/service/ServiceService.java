...
import com.rentspace.facade.FirebaseFacade;
...
public class ServiceService extends ModelMapperFuncs {
    ...
    public ResponseServiceDTO create(PersistServiceDTO persistDTO, MultipartFile file) throws IOException {
        ...
        if (file != null && !file.isEmpty()) {
            String fileName = firebaseFacade.uploadFile(file);
            persistDTO.getMedia().add(fileName);
        }
